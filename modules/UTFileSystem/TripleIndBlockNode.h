#ifndef UTFS_TripleIndBlockNode_h__
#define UTFS_TripleIndBlockNode_h__

/// @file BlockNode.h
/// Utopia FileSystem Triple Indirect Block Node Object.
///
...
class UTFS_EXP TripleIndBlockNode : public IndirectBlockNode
{
public:
    ...
    TripleIndBlockNode(Context & i_ctxt, BlockRef const & i_ref);

    virtual ~TripleIndBlockNode();
...
// The ZeroTripleIndBlockNode is a singleton which is used for
// read-only traversals of a sparse files.  If the read heads in to
// uninitialized territiory we route it through this block ...
//
class UTFS_EXP ZeroTripleIndBlockNode : public TripleIndBlockNode
{
public:
    // Constructor from a zero data block.
    ZeroTripleIndBlockNode(DoubleIndBlockNodeHandle const & i_nh);
...
#endif // UTFS_TripleIndBlockNode_h__
