...
UTFileSystem::rootref()
{
    ...
    m_hn.ParseFromString(m_shn.headnode());

    // Decrypt the root reference.
    uint8 iv[16];
    memset(iv, '\0', sizeof(iv));
    string const & refstr = m_hn.rootref();
